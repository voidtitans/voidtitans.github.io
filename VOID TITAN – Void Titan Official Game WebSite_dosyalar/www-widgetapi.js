...
function za(a){a.H=[a.j];a.m=0;a.o=0}
...
var tb={};sb("");var ub=String.prototype.trim?function(a){return a.trim()}:function(a){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(a)[1]},Ab=/&/g,Bb=/</g,Cb=/>/g,Db=/"/g,Eb=/'/g,Fb=/\x00/g,Gb=/[\x00&<>"']/;function Hb(a,b){this.h=b===Ib?a:""}
...
kc&&(jc=kc?kc[1]:"");if(dc){var lc=hc();if(null!=lc&&lc>parseFloat(jc)){ic=String(lc);break a}}ic=jc}var mc=ic,nc;if(z.document&&dc){var oc=hc();nc=oc?oc:parseInt(mc,10)||void 0}else nc=void 0;var pc=nc;var qc=ac()||F("iPod"),rc=F("iPad");!F("Android")||Lb();Lb();var sc=F("Safari")&&!(Lb()||F("Coast")||F("Opera")||F("Edge")||F("Edg/")||F("OPR")||F("Firefox")||F("FxiOS")||F("Silk")||F("Android"))&&!(ac()||F("iPad")||F("iPod"));var tc={},vc=null;function wc(a,b){Ma(a);void 0===b&&(b=0);xc();b=tc[b];for(var c=Array(Math.floor(a.length/3)),d=b[64]||"",e=0,f=0;e<a.length-2;e+=3){var g=a[e],h=a[e+1],k=a[e+2],l=b[g>>2];g=b[(g&3)<<4|h>>4];h=b[(h&15)<<2|k>>6];k=b[k&63];c[f++]=""+l+g+h+k}l=0;k=d;switch(a.length-e){case 2:l=a[e+1],k=b[(l&15)<<2]||d;case 1:a=a[e],c[f]=""+b[a>>2]+b[(a&3)<<4|l>>4]+k+d}return c.join("")}
...
function xc(){if(!vc){vc={};for(var a="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),b=["+/=","+/","-_=","-_.","-_"],c=0;5>c;c++){var d=a.concat(b[c].split(""));tc[c]=d;for(var e=0;e<d.length;e++){var f=d[e];void 0===vc[f]&&(vc[f]=e)}}}}
...
Fc.prototype.sizeBytes=function(){Ec();var a=this.ma;null==a||Bc(a)||("string"===typeof a?a=yc(a):(La(a),a=null));return(a=null==a?a:this.ma=a)?a.length:0};var Gc="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol():void 0;function Hc(a,b){if(Gc)return a[Gc]|=b;if(void 0!==a.N)return a.N|=b;Object.defineProperties(a,{N:{value:b,configurable:!0,writable:!0,enumerable:!1}});return b}
...
function od(a,b,c){var d=void 0===d?!1:d;var e=id(a,c,d);var f=!1;var g=null==e||"object"!==typeof e||(f=Array.isArray(e))||e.ya!==Sc?f?new b(e):void 0:e;g!==e&&null!=g&&(jd(a,c,g,d),Hc(g.v,G(a.v)&-33));b=kd(g,a);if(null==b)return b;Lc(a.v)||(e=pd(b),e!==b&&(b=e,jd(a,c,b,d)));return kd(b,a)}
function qd(a,b,c,d,e,f){a.h||(a.h={});var g=a.h[c],h=ld(a,c,3,d,f);if(g)f||(Object.isFrozen(g)?e||(g=Array.prototype.slice.call(g),a.h[c]=g):e&&Object.freeze(g));else{g=[];var k=!!(G(a.v)&16),l=Lc(h);!f&&l&&(h=Kc(Array.prototype.slice.call(h)),jd(a,c,h,d));d=l;for(var m=0;m<h.length;m++){var n=h[m];var r=b;var q=k,y=!1;y=void 0===y?!1:y;q=void 0===q?!1:q;r=Array.isArray(n)?new r(q?Pc(n):n):y?new r:void 0;void 0!==r&&(d=d||Lc(n),g.push(r),l&&Hc(r.v,2))}a.h[c]=g;a=h;b=!d;Object.isFrozen(a)||(c=G(a)|
...
function Dd(a,b){b.ia&&(a.ia=b.ia.slice());var c=b.h;if(c){b=b.i;for(var d in c){var e=c[d];if(e){var f=!(!b||!b[d]),g=+d;if(Array.isArray(e)){if(e.length){var h=a,k=e[0].constructor,l=Lc(h.v);k=qd(h,k,g,f,l,l);f=ld(h,g,3,f,l);if(!(l||G(f)&8)){for(l=0;l<k.length;l++)g=k[l],h=pd(g),g!==h&&(k[l]=h,f[l]=k[l].v);Hc(f,8)}for(l=0;l<Math.min(k.length,e.length);l++)Dd(k[l],e[l])}}else throw Error("unexpected object: type: "+La(e)+": "+e);}}}}
...
var Ld={};/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
var Nd;try{new URL("s://g"),Nd=!0}catch(a){Nd=!1}var Od=Nd;function Pd(a,b){a.removeAttribute("srcdoc");if(b instanceof Hb)b instanceof Hb&&b.constructor===Hb?b=b.h:(La(b),b="type_error:SafeUrl");else{b:if(Od){try{var c=new URL(b)}catch(d){c="https:";break b}c=c.protocol}else c:{c=document.createElement("a");try{c.href=b}catch(d){c=void 0;break c}c=c.protocol;c=":"===c||""===c?"https:":c}b="javascript:"!==c?b:void 0}void 0!==b&&(a.src=b);for(b="allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(" ");0<
...
;function Vd(a){var b=Yd;if(b)for(var c in b)Object.prototype.hasOwnProperty.call(b,c)&&a(b[c],c,b)}
function Zd(){var a=[];Vd(function(b){a.push(b)});
return a}
var Yd={Gb:"allow-forms",Hb:"allow-modals",Ib:"allow-orientation-lock",Jb:"allow-pointer-lock",Kb:"allow-popups",Lb:"allow-popups-to-escape-sandbox",Mb:"allow-presentation",Nb:"allow-same-origin",Ob:"allow-scripts",Pb:"allow-top-navigation",Qb:"allow-top-navigation-by-user-activation"},$d=$a(function(){return Zd()});
...
function b(n){for(var r=g,q=0;64>q;q+=4)r[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=r[q-3]^r[q-8]^r[q-14]^r[q-16],r[q]=(n<<1|n>>>31)&4294967295;n=e[0];var y=e[1],A=e[2],H=e[3],K=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var M=H^y&(A^H);var O=1518500249}else M=y^A^H,O=1859775393;else 60>q?(M=y&A|H&(y|A),O=2400959708):(M=y^A^H,O=3395469782);M=((n<<5|n>>>27)&4294967295)+M+K+O+r[q]&4294967295;K=H;H=A;A=(y<<30|y>>>2)&4294967295;y=n;n=M}e[0]=e[0]+n&4294967295;e[1]=e[1]+y&4294967295;e[2]=
...
e:"")};
p.get=function(a,b){for(var c=a+"=",d=(this.h.cookie||"").split(";"),e=0,f;e<d.length;e++){f=ub(d[e]);if(0==f.lastIndexOf(c,0))return f.slice(c.length);if(f==a)return""}return b};
...
function Qe(a,b){var c=a.C;if(c){var d=[];for(var e=1;c;c=c.C)d.push(c),++e}a=a.V;c=b.type||b;"string"===typeof b?b=new qe(b,a):b instanceof qe?b.target=b.target||a:(e=b,b=new qe(c,a),ob(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Re(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Re(g,c,!0,b)&&e,b.j||(e=Re(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Re(g,c,!1,b)&&e}
...
var c,d;this.i=null!=(d=null==(c=window.navigator)?void 0:c.onLine)?d:!0;this.m=function(){return x(function(e){return w(e,Te(b),0)})};
...
function Ue(a){a.H=a.J.L(function(){var b;return x(function(c){if(1==c.h)return a.i?(null==(b=window.navigator)?0:b.onLine)?c.s(3):w(c,Te(a),3):w(c,Te(a),3);Ue(a);c.h=0})},3E4)}
function Te(a,b){return a.u?a.u:a.u=new Promise(function(c){var d,e,f,g;return x(function(h){switch(h.h){case 1:return d=window.AbortController?new window.AbortController:void 0,f=null==(e=d)?void 0:e.signal,g=!1,wa(h,2,3),d&&(a.l=a.J.L(function(){d.abort()},b||2E4)),w(h,fetch("/generate_204",{method:"HEAD",
signal:f}),5);case 5:g=!0;case 3:za(h);a.u=void 0;a.l&&(a.J.Z(a.l),a.l=0);g!==a.i&&(a.i=g,a.i?Qe(a,"networkstatus-online"):Qe(a,"networkstatus-offline"));c(g);Ba(h);break;case 2:ya(h),g=!1,h.s(3)}})})}
...
;function Xf(a){this.h=0;this.u=void 0;this.l=this.i=this.j=null;this.o=this.m=!1;if(a!=Za)try{var b=this;a.call(void 0,function(c){Yf(b,2,c)},function(c){Yf(b,3,c)})}catch(c){Yf(this,3,c)}}
function Zf(){this.next=this.context=this.i=this.j=this.h=null;this.l=!1}
Zf.prototype.reset=function(){this.context=this.i=this.j=this.h=null;this.l=!1};
var wg=new rf(function(){return new Zf},function(a){a.reset()});
...
var li=$a(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
function wi(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=vi(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);b=a;a=Tb(e);a?(c=b.indexOf("#"),0>c&&(c=b.length),f=b.indexOf("?"),0>f||f>c?(f=c,e=""):e=b.substring(f+1,c),b=[b.slice(0,f),e,b.slice(c)],c=b[1],b[1]=a?c?c+"&"+a:a:c,a=b[0]+(b[1]?"?"+b[1]:"")+b[2]):a=b;return a+d}
...
(n=Ed.screen)?void 0:n.availWidth;var r;e.u_cd=null==(r=Ed.screen)?void 0:r.colorDepth}catch(W){}h=b.h;try{var q=h.screenX;var y=h.screenY}catch(W){}try{var A=h.outerWidth;var H=h.outerHeight}catch(W){}try{var K=h.innerWidth;var M=h.innerHeight}catch(W){}try{var O=h.screenLeft;var pb=h.screenTop}catch(W){}try{K=h.innerWidth,M=h.innerHeight}catch(W){}try{var uc=h.screen.availWidth;var Aa=h.screen.availTop}catch(W){}q=[O,pb,q,y,uc,Aa,A,H,K,M];y=b.h.top;try{var ra=(y||window).document,X="CSS1Compat"==
ra.compatMode?ra.documentElement:ra.body;var ca=(new Gd(X.clientWidth,X.clientHeight)).round()}catch(W){ca=new Gd(-12245933,-12245933)}ra=ca;ca={};var da=void 0===da?z:da;X=new Xe;da.SVGElement&&da.document.createElementNS&&X.set(0);y=ae();y["allow-top-navigation-by-user-activation"]&&X.set(1);y["allow-popups-to-escape-sandbox"]&&X.set(2);da.crypto&&da.crypto.subtle&&X.set(3);da.TextDecoder&&da.TextEncoder&&X.set(4);da=Ye(X);ca.bc=da;ca.bih=ra.height;ca.biw=ra.width;ca.brdim=q.join();b=b.i;b=(ca.vis=
...
function Ji(a,b){var c=P("XSRF_FIELD_NAME"),d=P("XSRF_TOKEN"),e=b.postBody||"",f=b.postParams,g=P("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||Qb(a)&&!b.withCredentials&&Qb(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);(R("ajax_parse_query_data_only_when_filled")&&f&&0<Object.keys(f).length||f)&&"string"===typeof e&&(e=vi(e),ob(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?
JSON.stringify(e):Tb(e));if(!(a=e)&&(a=f)){a:{for(var k in f){f=!1;break a}f=!0}a=!f}!Ei&&a&&"POST"!=b.method&&(Ei=!0,$h(Error("AJAX request with postData should use POST")));return e}
...
v(Zi,Vi);function $i(){Zi.h||(Zi.h=new Zi);return Zi.h}
function Xi(a,b,c){void 0!==c&&Number.isNaN(Number(c))&&(c=void 0);var d=C("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):ni(a,c||0)}
Zi.prototype.Z=function(a){if(void 0===a||!Number.isNaN(Number(a))){var b=C("yt.scheduler.instance.cancelJob");b?b(a):window.clearTimeout(a)}};
Zi.prototype.start=function(){var a=C("yt.scheduler.instance.start");a&&a()};
var We=$i();function aj(a){var b=Ia.apply(1,arguments);var c=Error.call(this,a);this.message=c.message;"stack"in c&&(this.stack=c.stack);this.args=[].concat(ia(b))}
v(aj,Error);function bj(){try{return cj(),!0}catch(a){return!1}}
function cj(){if(void 0!==P("DATASYNC_ID"))return P("DATASYNC_ID");throw new aj("Datasync ID not set","unknown");}
;var dj=qc||rc;function ej(a){var b=new Ug;if(b.h)try{b.h.setItem("__sak","1");b.h.removeItem("__sak");var c=!0}catch(d){c=!1}else c=!1;(b=c?a?new $g(b,a):b:null)||(a=new Vg(a||"UserDataSharedStore"),b=a.h?a:null);this.h=(a=b)?new Qg(a):null;this.i=document.domain||window.location.hostname}
ej.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Vf(b))}catch(f){return}else e=escape(b);b=this.i;le.set(""+a,e,{Ia:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
ej.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=le.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
ej.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;le.remove(""+a,"/",void 0===b?"youtube.com":b)};var fj=function(){var a;return function(){a||(a=new ej("ytidb"));return a}}();
...
;var nj={},oj=(nj.AUTH_INVALID="No user identifier specified.",nj.EXPLICIT_ABORT="Transaction was explicitly aborted.",nj.IDB_NOT_SUPPORTED="IndexedDB is not supported.",nj.MISSING_INDEX="Index not created.",nj.MISSING_OBJECT_STORES="Object stores not created.",nj.DB_DELETED_BY_MISSING_OBJECT_STORES="Database is deleted because expected object stores were not created.",nj.DB_REOPENED_BY_MISSING_OBJECT_STORES="Database is reopened because expected object stores were not created.",nj.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",
nj.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",nj.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",nj.EXECUTE_TRANSACTION_ON_CLOSED_DB="Can't start a transaction on a closed database",nj.INCOMPATIBLE_DB_VERSION="The binary is incompatible with the database version",nj),pj={},qj=(pj.AUTH_INVALID="ERROR",pj.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",pj.EXPLICIT_ABORT="IGNORED",pj.IDB_NOT_SUPPORTED="ERROR",pj.MISSING_INDEX=
"WARNING",pj.MISSING_OBJECT_STORES="ERROR",pj.DB_DELETED_BY_MISSING_OBJECT_STORES="WARNING",pj.DB_REOPENED_BY_MISSING_OBJECT_STORES="WARNING",pj.QUOTA_EXCEEDED="WARNING",pj.QUOTA_MAYBE_EXCEEDED="WARNING",pj.UNKNOWN_ABORT="WARNING",pj.INCOMPATIBLE_DB_VERSION="WARNING",pj),rj={},sj=(rj.AUTH_INVALID=!1,rj.EXECUTE_TRANSACTION_ON_CLOSED_DB=!1,rj.EXPLICIT_ABORT=!1,rj.IDB_NOT_SUPPORTED=!1,rj.MISSING_INDEX=!1,rj.MISSING_OBJECT_STORES=!1,rj.DB_DELETED_BY_MISSING_OBJECT_STORES=!1,rj.DB_REOPENED_BY_MISSING_OBJECT_STORES=
!1,rj.QUOTA_EXCEEDED=!1,rj.QUOTA_MAYBE_EXCEEDED=!0,rj.UNKNOWN_ABORT=!0,rj.INCOMPATIBLE_DB_VERSION=!1,rj);function T(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?oj[a]:c;d=void 0===d?qj[a]:d;e=void 0===e?sj[a]:e;aj.call(this,c,Object.assign({},{name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.h=e;Object.setPrototypeOf(this,T.prototype)}
v(T,aj);function tj(a,b){T.call(this,"MISSING_OBJECT_STORES",{expectedObjectStores:b,foundObjectStores:a},oj.MISSING_OBJECT_STORES);Object.setPrototypeOf(this,tj.prototype)}
v(tj,T);function uj(a,b){var c=Error.call(this);this.message=c.message;"stack"in c&&(this.stack=c.stack);this.index=a;this.objectStore=b;Object.setPrototypeOf(this,uj.prototype)}
...
function wj(a,b,c,d){b=mj(b);var e=a instanceof Error?a:Error("Unexpected error: "+a);if(e instanceof T)return e;a={objectStoreNames:c,dbName:b,dbVersion:d};if("QuotaExceededError"===e.name)return new T("QUOTA_EXCEEDED",a);if(sc&&"UnknownError"===e.name)return new T("QUOTA_MAYBE_EXCEEDED",a);if(e instanceof uj)return new T("MISSING_INDEX",Object.assign({},a,{objectStore:e.objectStore,index:e.index}));if("InvalidStateError"===e.name&&vj.some(function(f){return e.message.includes(f)}))return new T("EXECUTE_TRANSACTION_ON_CLOSED_DB",
a);
...
function xj(a,b,c){var d=gj();return new T("IDB_NOT_SUPPORTED",{context:{caller:a,publicName:b,version:c,hasSucceededOnce:null==d?void 0:d.hasSucceededOnce}})}
;function yj(a){if(!a)throw Error();throw a;}
function zj(a){return a}
function Aj(a){this.h=a}
function Bj(a){function b(e){if("PENDING"===d.state.status){d.state={status:"REJECTED",reason:e};e=u(d.i);for(var f=e.next();!f.done;f=e.next())f=f.value,f()}}
function c(e){if("PENDING"===d.state.status){d.state={status:"FULFILLED",value:e};e=u(d.h);for(var f=e.next();!f.done;f=e.next())f=f.value,f()}}
var d=this;this.state={status:"PENDING"};this.h=[];this.i=[];a=a.h;try{a(c,b)}catch(e){b(e)}}
Bj.resolve=function(a){return new Bj(new Aj(function(b,c){a instanceof Bj?a.then(b,c):b(a)}))};
Bj.reject=function(a){return new Bj(new Aj(function(b,c){c(a)}))};
Bj.prototype.then=function(a,b){var c=this,d=null!=a?a:zj,e=null!=b?b:yj;return new Bj(new Aj(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){Cj(c,c,d,f,g)}),c.i.push(function(){Dj(c,c,e,f,g)})):"FULFILLED"===c.state.status?Cj(c,c,d,f,g):"REJECTED"===c.state.status&&Dj(c,c,e,f,g)}))};
function Ej(a,b){a.then(void 0,b)}
function Cj(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof Bj?Fj(a,b,f,d,e):d(f)}catch(g){e(g)}}
function Dj(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof Bj?Fj(a,b,f,d,e):d(f)}catch(g){e(g)}}
function Fj(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof Bj?Fj(a,b,f,d,e):d(f)},function(f){e(f)})}
...
function Ij(a){return new Bj(new Aj(function(b,c){Gj(a,b,c)}))}
;function Jj(a,b){return new Bj(new Aj(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()}))}
;var Kj=window,U=Kj.ytcsi&&Kj.ytcsi.now?Kj.ytcsi.now:Kj.performance&&Kj.performance.timing&&Kj.performance.now&&Kj.performance.timing.navigationStart?function(){return Kj.performance.timing.navigationStart+Kj.performance.now()}:function(){return(new Date).getTime()};function Lj(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(U());this.i=!1}
p=Lj.prototype;p.add=function(a,b,c){return V(this,[a],{mode:"readwrite",G:!0},function(d){return d.objectStore(a).add(b,c)})};
...
function Mj(a,b,c){a=a.h.createObjectStore(b,c);return new Nj(a)}
...
function Oj(a,b,c){return V(a,[b],{mode:"readwrite",G:!0},function(d){d=d.objectStore(b);return Ij(d.h.put(c,void 0))})}
p.objectStoreNames=function(){return Array.from(this.h.objectStoreNames)};
function V(a,b,c,d){var e,f,g,h,k,l,m,n,r,q,y,A;return x(function(H){switch(H.h){case 1:var K={mode:"readonly",G:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?K.mode=c:Object.assign(K,c);e=K;a.transactionCount++;f=e.G?3:1;g=0;case 2:if(h){H.s(3);break}g++;k=Math.round(U());wa(H,4);l=a.h.transaction(b,e.mode);K=new Pj(l);K=Qj(K,d);return w(H,K,6);case 6:return m=H.i,n=Math.round(U()),Rj(a,k,n,g,void 0,b.join(),e),H.return(m);case 4:r=ya(H);q=Math.round(U());y=wj(r,a.h.name,b.join(),a.h.version);
if((A=y instanceof T&&!y.h)||g>=f)Rj(a,k,q,g,y,b.join(),e),h=y;H.s(2);break;case 3:return H.return(Promise.reject(h))}})}
function Rj(a,b,c,d,e,f,g){b=c-b;e?(e instanceof T&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&kj("QUOTA_EXCEEDED",{dbName:mj(a.h.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof T&&"UNKNOWN_ABORT"===e.type&&(c-=a.j,0>c&&c>=Math.pow(2,31)&&(c=0),kj("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c}),a.i=!0),Sj(a,!1,d,f,b,g.tag),jj(e)):Sj(a,!0,d,f,b,g.tag)}
function Sj(a,b,c,d,e,f){kj("TRANSACTION_ENDED",{objectStoreNames:d,connectionHasUnknownAbortedTransaction:a.i,duration:e,isSuccessful:b,tryCount:c,tag:void 0===f?"IDB_TRANSACTION_TAG_UNKNOWN":f})}
p.getName=function(){return this.h.name};
function Nj(a){this.h=a}
p=Nj.prototype;p.add=function(a,b){return Ij(this.h.add(a,b))};
p.autoIncrement=function(){return this.h.autoIncrement};
p.clear=function(){return Ij(this.h.clear()).then(function(){})};
function Tj(a,b,c){a.h.createIndex(b,c,{unique:!1})}
function Uj(a,b){return Vj(a,{query:b},function(c){return c.delete().then(function(){return c.continue()})}).then(function(){})}
p.delete=function(a){return a instanceof IDBKeyRange?Uj(this,a):Ij(this.h.delete(a))};
p.get=function(a){return Ij(this.h.get(a))};
p.index=function(a){try{return new Wj(this.h.index(a))}catch(b){if(b instanceof Error&&"NotFoundError"===b.name)throw new uj(a,this.h.name);throw b;}};
p.getName=function(){return this.h.name};
p.keyPath=function(){return this.h.keyPath};
function Vj(a,b,c){a=a.h.openCursor(b.query,b.direction);return Xj(a).then(function(d){return Jj(d,c)})}
function Pj(a){var b=this;this.h=a;this.j=new Map;this.i=!1;this.done=new Promise(function(c,d){b.h.addEventListener("complete",function(){c()});
...
function Qj(a,b){var c=new Promise(function(d,e){try{Ej(b(a).then(function(f){d(f)}),e)}catch(f){e(f),a.abort()}});
return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
Pj.prototype.abort=function(){this.h.abort();this.i=!0;throw new T("EXPLICIT_ABORT");};
Pj.prototype.objectStore=function(a){a=this.h.objectStore(a);var b=this.j.get(a);b||(b=new Nj(a),this.j.set(a,b));return b};
function Wj(a){this.h=a}
p=Wj.prototype;p.delete=function(a){return Yj(this,{query:a},function(b){return b.delete().then(function(){return b.continue()})})};
p.get=function(a){return Ij(this.h.get(a))};
p.getKey=function(a){return Ij(this.h.getKey(a))};
p.keyPath=function(){return this.h.keyPath};
p.unique=function(){return this.h.unique};
function Yj(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return Xj(a).then(function(d){return Jj(d,c)})}
function Zj(a,b){this.request=a;this.cursor=b}
function Xj(a){return Ij(a).then(function(b){return b?new Zj(a,b):null})}
p=Zj.prototype;p.advance=function(a){this.cursor.advance(a);return Xj(this.request)};
p.continue=function(a){this.cursor.continue(a);return Xj(this.request)};
p.delete=function(){return Ij(this.cursor.delete()).then(function(){})};
p.getKey=function(){return this.cursor.key};
p.M=function(){return this.cursor.value};
p.update=function(a){return Ij(this.cursor.update(a))};function ak(a,b,c){return new Promise(function(d,e){function f(){r||(r=new Lj(g.result,{closed:n}));return r}
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.jb,k=c.kb,l=c.Bb,m=c.upgrade,n=c.closed,r;g.addEventListener("upgradeneeded",function(q){try{if(null===q.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");q.dataLoss&&"none"!==q.dataLoss&&kj("IDB_DATA_CORRUPTED",{reason:q.dataLossMessage||"unknown reason",dbName:mj(a)});var y=f(),A=new Pj(g.transaction);m&&
m(y,function(H){return q.oldVersion<H&&q.newVersion>=H},A);
A.done.catch(function(H){e(H)})}catch(H){e(H)}});
g.addEventListener("success",function(){var q=g.result;k&&q.addEventListener("versionchange",function(){k(f())});
q.addEventListener("close",function(){kj("IDB_UNEXPECTEDLY_CLOSED",{dbName:mj(a),dbVersion:q.version});l&&l()});
d(f())});
g.addEventListener("error",function(){e(g.error)});
h&&g.addEventListener("blocked",function(){h()})})}
function Pk(a,b,c){c=void 0===c?{}:c;return ak(a,b,c)}
function Qk(a,b){b=void 0===b?{}:b;var c,d,e,f;return x(function(g){if(1==g.h)return wa(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.jb)&&c.addEventListener("blocked",function(){e()}),w(g,Hj(c),4);
if(2!=g.h)return xa(g,0);f=ya(g);throw wj(f,a,"",-1);})}
;function Rk(a){return new Promise(function(b){Yi(function(){b()},a)})}
function Sk(a,b){this.name=a;this.options=b;this.l=!0;this.m=this.o=0;this.i=500}
Sk.prototype.j=function(a,b,c){c=void 0===c?{}:c;return Pk(a,b,c)};
...
function Uk(a,b){if(!b)throw xj("openWithToken",mj(a.name));return Vk(a)}
function Vk(a){function b(){var f,g,h,k,l,m,n,r,q,y;return x(function(A){switch(A.h){case 1:return g=null!=(f=Error().stack)?f:"",wa(A,2),w(A,a.j(a.name,a.options.version,d),4);case 4:h=A.i;for(var H=a.options,K=[],M=u(Object.keys(H.da)),O=M.next();!O.done;O=M.next()){O=O.value;var pb=H.da[O],uc=void 0===pb.Ab?Number.MAX_VALUE:pb.Ab;!(h.h.version>=pb.ga)||h.h.version>=uc||h.h.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){A.s(5);break}l=Object.keys(a.options.da);m=h.objectStoreNames();
if(a.m<ci("ytidb_reopen_db_retries",0))return a.m++,h.close(),jj(new T("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),A.return(b());if(!(a.o<ci("ytidb_remake_db_retries",1))){A.s(6);break}a.o++;if(!R("ytidb_remake_db_enable_backoff_delay")){A.s(7);break}return w(A,Rk(a.i),8);case 8:a.i*=2;case 7:return w(A,a.delete(),9);case 9:return jj(new T("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:a.name,expectedObjectStores:l,foundObjectStores:m})),A.return(b());
case 6:throw new tj(m,l);case 5:return A.return(h);case 2:n=ya(A);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){A.s(10);break}return w(A,a.j(a.name,void 0,Object.assign({},d,{upgrade:void 0})),11);case 11:r=A.i;q=r.h.version;if(void 0!==a.options.version&&q>a.options.version+1)throw r.close(),
a.l=!1,Tk(a,q);return A.return(r);case 10:throw c(),n instanceof Error&&!R("ytidb_async_stack_killswitch")&&(n.stack=n.stack+"\n"+g.substring(g.indexOf("\n")+1)),wj(n,a.name,"",null!=(y=a.options.version)?y:-1);}})}
function c(){a.h===e&&(a.h=void 0)}
if(!a.l)throw Tk(a);if(a.h)return a.h;var d={kb:function(f){f.close()},
closed:c,Bb:c,upgrade:a.options.upgrade};var e=b();a.h=e;return a.h}
;var Wk=new Sk("YtIdbMeta",{da:{databases:{ga:1}},upgrade:function(a,b){b(1)&&Mj(a,"databases",{keyPath:"actualName"})}});
function Xk(a,b){var c;return x(function(d){if(1==d.h)return w(d,Uk(Wk,b),2);c=d.i;return d.return(V(c,["databases"],{G:!0,mode:"readwrite"},function(e){var f=e.objectStore("databases");return f.get(a.actualName).then(function(g){if(g?a.actualName!==g.actualName||a.publicName!==g.publicName||a.userIdentifier!==g.userIdentifier:1)return Ij(f.h.put(a,void 0)).then(function(){})})}))})}
function Yk(a,b){var c;return x(function(d){if(1==d.h)return a?w(d,Uk(Wk,b),2):d.return();c=d.i;return d.return(c.delete("databases",a))})}
function Zk(a,b){var c,d;return x(function(e){return 1==e.h?(c=[],w(e,Uk(Wk,b),2)):3!=e.h?(d=e.i,w(e,V(d,["databases"],{G:!0,mode:"readonly"},function(f){c.length=0;return Vj(f.objectStore("databases"),{},function(g){a(g.M())&&c.push(g.M());return g.continue()})}),3)):e.return(c)})}
...
function cl(){var a,b,c,d;return x(function(e){switch(e.h){case 1:a=gj();if(null==(b=a)?0:b.hasSucceededOnce)return e.return(!0);var f;if(f=dj)f=/WebKit\/([0-9]+)/.exec(Kb()),f=!!(f&&600<=parseInt(f[1],10));f&&(f=/WebKit\/([0-9]+)/.exec(Kb()),f=!(f&&602<=parseInt(f[1],10)));if(f||ec)return e.return(!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e.return(!1)}catch(g){return e.return(!1)}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return e.return(!1);
...
;new Wf;function gl(a){if(!bj())throw a=new T("AUTH_INVALID",{dbName:a}),jj(a),a;var b=cj();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function hl(a,b,c,d){var e,f,g,h,k,l;return x(function(m){switch(m.h){case 1:return f=null!=(e=Error().stack)?e:"",w(m,fl(),2);case 2:g=m.i;if(!g)throw h=xj("openDbImpl",a,b),R("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),jj(h),h;lj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:gl(a);wa(m,3);return w(m,Xk(k,g),5);case 5:return w(m,Pk(k.actualName,b,d),6);case 6:return m.return(m.i);case 3:return l=ya(m),wa(m,7),w(m,Yk(k.actualName,g),9);case 9:xa(m,
...
function kl(a,b){b=void 0===b?{}:b;var c,d;return x(function(e){if(1==e.h)return w(e,fl(),2);if(3!=e.h){c=e.i;if(!c)return e.return();lj(a);d=gl(a);return w(e,Qk(d.actualName,b),3)}return w(e,Yk(d.actualName,c),0)})}
function ll(a,b,c){a=a.map(function(d){return x(function(e){return 1==e.h?w(e,Qk(d.actualName,b),2):w(e,Yk(d.actualName,c),0)})});
return Promise.all(a).then(function(){})}
function ml(){var a=void 0===a?{}:a;var b,c;return x(function(d){if(1==d.h)return w(d,fl(),2);if(3!=d.h){b=d.i;if(!b)return d.return();lj("LogsDatabaseV2");return w(d,$k(b),3)}c=d.i;return w(d,ll(c,a,b),0)})}
function nl(a,b){b=void 0===b?{}:b;var c;return x(function(d){if(1==d.h)return w(d,fl(),2);if(3!=d.h){c=d.i;if(!c)return d.return();lj(a);return w(d,Qk(a,b),3)}return w(d,Yk(a,c),0)})}
;function ol(a,b){Sk.call(this,a,b);this.options=b;lj(a)}
v(ol,Sk);function pl(a,b){var c;return function(){c||(c=new ol(a,b));return c}}
ol.prototype.j=function(a,b,c){c=void 0===c?{}:c;return(this.options.Da?jl:il)(a,b,Object.assign({},c))};
ol.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Da?nl:kl)(this.name,a)};
function ql(a,b){return pl(a,b)}
;var rl={},sl=ql("ytGcfConfig",{da:(rl.coldConfigStore={ga:1},rl.hotConfigStore={ga:1},rl),Da:!1,upgrade:function(a,b){b(1)&&(Tj(Mj(a,"hotConfigStore",{keyPath:"key",autoIncrement:!0}),"hotTimestampIndex","timestamp"),Tj(Mj(a,"coldConfigStore",{keyPath:"key",autoIncrement:!0}),"coldTimestampIndex","timestamp"))},
version:1});function tl(a){return Uk(sl(),a)}
function ul(a,b,c){var d,e,f;return x(function(g){switch(g.h){case 1:return d={config:a,hashData:b,timestamp:U()},w(g,tl(c),2);case 2:return e=g.i,w(g,e.clear("hotConfigStore"),3);case 3:return w(g,Oj(e,"hotConfigStore",d),4);case 4:return f=g.i,g.return(f)}})}
function vl(a,b,c,d){var e,f,g;return x(function(h){switch(h.h){case 1:return e={config:a,hashData:b,configData:c,timestamp:U()},w(h,tl(d),2);case 2:return f=h.i,w(h,f.clear("coldConfigStore"),3);case 3:return w(h,Oj(f,"coldConfigStore",e),4);case 4:return g=h.i,h.return(g)}})}
function wl(a){var b,c;return x(function(d){return 1==d.h?w(d,tl(a),2):3!=d.h?(b=d.i,c=void 0,w(d,V(b,["coldConfigStore"],{mode:"readwrite",G:!0},function(e){return Yj(e.objectStore("coldConfigStore").index("coldTimestampIndex"),{direction:"prev"},function(f){c=f.M()})}),3)):d.return(c)})}
function xl(a){var b,c;return x(function(d){return 1==d.h?w(d,tl(a),2):3!=d.h?(b=d.i,c=void 0,w(d,V(b,["hotConfigStore"],{mode:"readwrite",G:!0},function(e){return Yj(e.objectStore("hotConfigStore").index("hotTimestampIndex"),{direction:"prev"},function(f){c=f.M()})}),3)):d.return(c)})}
;function yl(){}
function zl(a,b,c){var d,e,f,g;return x(function(h){if(1==h.h){if(!R("gcf_config_store_update_enabled"))return h.s(0);c&&(a.h=c,B("yt.gcf.config.hotConfigGroup",a.h));a.hotHashData=b;B("yt.gcf.config.hotHashData",a.hotHashData);d=el();return d?c?h.s(4):w(h,xl(d),5):(e=xj("updateHotConfig token error"),ai(e),h.s(0))}4!=h.h&&(f=h.i,c=null==(g=f)?void 0:g.config);return w(h,ul(c,b,d),0)})}
function Al(a,b,c){var d,e,f,g,h;return x(function(k){if(1==k.h){if(!R("gcf_config_store_update_enabled"))return k.s(0);a.coldHashData=b;B("yt.gcf.config.coldHashData",a.coldHashData);d=el();return d?c?k.s(4):w(k,wl(d),5):(e=xj("updateColdConfig token error"),ai(e),k.s(0))}4!=k.h&&(f=k.i,c=null==(g=f)?void 0:g.config);if(!c)return k.s(0);h=c.configData;return w(k,vl(c,b,h,d),0)})}
;function Bl(){return"INNERTUBE_API_KEY"in Th&&"INNERTUBE_API_VERSION"in Th}
function Cl(){return{rb:P("INNERTUBE_API_KEY"),sb:P("INNERTUBE_API_VERSION"),Ha:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ta:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),tb:P("INNERTUBE_CONTEXT_CLIENT_NAME",1),Ua:P("INNERTUBE_CONTEXT_CLIENT_VERSION"),Wa:P("INNERTUBE_CONTEXT_HL"),Va:P("INNERTUBE_CONTEXT_GL"),ub:P("INNERTUBE_HOST_OVERRIDE")||"",wb:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),vb:!!P("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",!1),appInstallData:P("SERIALIZED_CLIENT_CONFIG_DATA")}}
function Dl(a){var b={client:{hl:a.Wa,gl:a.Va,clientName:a.Ta,clientVersion:a.Ua,configInfo:a.Ha}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=z.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=P("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=di();0<c.length&&(b.request={internalExperimentFlags:c});El(a,void 0,b);R("enable_third_party_info")&&Fl(void 0,b);Gl(void 0,b);Hl(a,void 0,b);Il(void 0,b);R("start_sending_config_hash")&&Jl(void 0,
...
function Kl(a){var b=new sh,c=new jh;I(c,1,a.Wa);I(c,2,a.Va);I(c,16,a.tb);I(c,17,a.Ua);if(a.Ha){var d=a.Ha,e=new fh;d.coldConfigData&&I(e,1,d.coldConfigData);d.appInstallData&&I(e,6,d.appInstallData);d.coldHashData&&I(e,3,d.coldHashData);d.hotHashData&&I(e,5,d.hotHashData);J(c,fh,62,e)}(d=z.devicePixelRatio)&&1!=d&&I(c,65,d);d=P("EXPERIMENTS_TOKEN","");""!==d&&I(c,54,d);d=di();if(0<d.length){e=new lh;for(var f=0;f<d.length;f++){var g=new dh;I(g,1,d[f].key);md(g,2,eh,d[f].value);td(e,15,dh,g)}J(b,
lh,5,e)}El(a,c);R("enable_third_party_info")&&Fl(b);Gl(c);Hl(a,c);Il(c);R("start_sending_config_hash")&&Jl(c);P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(a=new qh,I(a,3,P("DELEGATED_SESSION_ID")));a=u(Object.entries(vi(P("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=u(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?I(c,12,e):"cmodel"===d?I(c,13,e):"cbr"===d?I(c,87,e):"cbrver"===d?I(c,88,e):"cos"===d?I(c,18,e):"cosver"===d?I(c,19,e):"cplatform"===d&&I(c,42,e);J(b,jh,1,c);
return b}
function El(a,b,c){a=a.Ta;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=od(b,gh,96)||new gh;var d=Pi();d=Object.keys(uh).indexOf(d);d=-1===d?null:d;null!==d&&I(c,3,d);J(b,gh,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Pi())}
function Fl(a,b){var c=C("yt.embedded_player.embed_url");c&&(a?(b=od(a,nh,7)||new nh,I(b,4,c),J(a,nh,7,b)):b&&(b.thirdParty={embedUrl:c}))}
function Gl(a,b){var c;if(R("web_log_memory_total_kbytes")&&(null==(c=z.navigator)?0:c.deviceMemory)){var d;c=null==(d=z.navigator)?void 0:d.deviceMemory;a?I(a,95,1E6*c):b&&(b.client.memoryTotalKbytes=""+1E6*c)}}
function Hl(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=od(b,fh,62))?d:new fh;I(c,6,a.appInstallData);J(b,fh,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
function Il(a,b){a:{var c=Ui();if(c){var d=Qi[c.type||"unknown"]||"CONN_UNKNOWN";c=Qi[c.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===d&&"CONN_UNKNOWN"!==c&&(d=c);if("CONN_UNKNOWN"!==d)break a;if("CONN_UNKNOWN"!==c){d=c;break a}}d=void 0}d&&(a?I(a,61,Ri[d]):b&&(b.client.connectionType=d));R("web_log_effective_connection_type")&&(d=Ui(),d=null!=d&&d.effectiveType?Ti.hasOwnProperty(d.effectiveType)?Ti[d.effectiveType]:"EFFECTIVE_CONNECTION_TYPE_UNKNOWN":void 0,d&&(a?I(a,94,Si[d]):
b&&(b.client.effectiveConnectionType=d)))}
function Ll(a,b,c){c=void 0===c?{}:c;var d={};P("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":P("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Xb||P("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Wb:b=oe([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
;function Ml(a){a=Object.assign({},a);delete a.Authorization;var b=oe();if(b){var c=new Hf;c.update(P("INNERTUBE_API_KEY"));c.update(b);a.hash=wc(c.digest(),3)}return a}
;var Nl;function Ol(){Nl||(Nl=new ej("yt.innertube"));return Nl}
function Pl(a,b,c,d){if(d)return null;d=Ol().get("nextId",!0)||1;var e=Ol().get("requests",!0)||{};e[d]={method:a,request:b,authState:Ml(c),requestTime:Math.round(U())};Ol().set("nextId",d+1,86400,!0);Ol().set("requests",e,86400,!0);return d}
function Ql(a){var b=Ol().get("requests",!0)||{};delete b[a];Ol().set("requests",b,86400,!0)}
function Rl(a){var b=Ol().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=Ml(Ll(!1));lb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),Sl(a,d.method,e,{}));delete b[c]}}Ol().set("requests",b,86400,!0)}}
;function Tl(a){this.qa=this.h=!1;this.potentialEsfErrorCounter=this.i=0;this.handleError=function(){};
this.ca=function(){};
...
this.Ka=a.Ka;Ul(this)&&(!this.B||this.B("networkless_logging"))&&Vl(this)}
function Vl(a){Ul(a)&&!a.ha&&(a.h=!0,a.va&&Math.random()<=a.ta&&a.D.mb(a.A),Wl(a),a.F.I()&&a.ka(),a.F.X(a.La,a.ka.bind(a)),a.F.X(a.Ka,a.Oa.bind(a)))}
...
Yl(d,g)})}else this.R(a,b,this.B&&this.B("nwl_skip_retry")&&c)};
...
this.R(d.url,d.options);this.D.set(d,this.A).then(function(g){d.id=g;e&&c.D.aa(d.id,c.A)}).catch(function(g){Yl(c,g)})}else this.R(a,b)};
p.ka=function(){var a=this;if(!Ul(this))throw xj("throttleSend");this.i||(this.i=this.J.L(function(){var b;return x(function(c){if(1==c.h)return w(c,a.D.Sa("NEW",a.A),2);if(3!=c.h)return b=c.i,b?w(c,Xl(a,b),3):(a.Oa(),c.return());a.i&&(a.i=0,a.ka());c.h=0})},this.fb))};
p.Oa=function(){this.J.Z(this.i);this.i=0};
function Xl(a,b){var c,d;return x(function(e){switch(e.h){case 1:if(!Ul(a))throw c=xj("immediateSend"),c;if(void 0===b.id){e.s(2);break}return w(e,a.D.yb(b.id,a.A),3);case 3:(d=e.i)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(Zl(a,b,a.bb)){e.s(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.s(5);break}return w(e,a.D.aa(b.id,a.A),5);case 5:return e.return();case 4:b.skipRetry||(b=$l(a,b));if(!b){e.s(0);break}if(!b.skipRetry||
void 0===b.id){e.s(8);break}return w(e,a.D.aa(b.id,a.A),8);case 8:a.R(b.url,b.options,!!b.skipRetry),e.h=0}})}
function $l(a,b){if(!Ul(a))throw xj("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.h){case 1:g=am(f);if(!(a.B&&a.B("nwl_consider_error_code")&&g||a.B&&!a.B("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.Aa)){l.s(2);break}if(!a.F.Ca){l.s(3);break}return w(l,a.F.Ca(),3);case 3:if(a.F.I()){l.s(2);break}c(e,f);if(!a.B||!a.B("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.s(6);break}return w(l,a.D.Ma(b.id,a.A,!1),6);case 6:return l.return();case 2:if(a.B&&a.B("nwl_consider_error_code")&&
...
b.options.onSuccess=function(e,f){var g;return x(function(h){if(1==h.h)return void 0===(null==(g=b)?void 0:g.id)?h.s(2):w(h,a.D.aa(b.id,a.A),2);a.F.Y&&a.B&&a.B("vss_network_hint")&&a.F.Y(!0);d(e,f);h.h=0})};
return b}
function Zl(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function Wl(a){if(!Ul(a))throw xj("retryQueuedRequests");a.D.Sa("QUEUED",a.A).then(function(b){b&&!Zl(a,b,a.ab)?a.J.L(function(){return x(function(c){if(1==c.h)return void 0===b.id?c.s(2):w(c,a.D.Ma(b.id,a.A),2);Wl(a);c.h=0})}):a.F.I()&&a.ka()})}
function Yl(a,b){a.gb&&!a.F.I()?a.gb(b):a.handleError(b)}
function Ul(a){return!!a.A||a.qa}
function am(a){var b;return(a=null==a?void 0:null==(b=a.error)?void 0:b.code)&&400<=a&&599>=a?!1:!0}
;var bm=C("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.la;N.prototype.publish=N.prototype.ea;N.prototype.clear=N.prototype.clear;B("ytPubsub2Pubsub2Instance",bm);B("ytPubsub2Pubsub2SubscribedKeys",C("ytPubsub2Pubsub2SubscribedKeys")||{});B("ytPubsub2Pubsub2TopicToKeys",C("ytPubsub2Pubsub2TopicToKeys")||{});B("ytPubsub2Pubsub2IsAsync",C("ytPubsub2Pubsub2IsAsync")||{});B("ytPubsub2Pubsub2SkipSubKey",null);var cm;
function dm(){if(cm)return cm();var a={};cm=ql("LogsDatabaseV2",{da:(a.LogsRequestsStore={ga:2},a),Da:!1,upgrade:function(b,c,d){c(2)&&Mj(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.h.indexNames.contains("newRequest")&&d.h.deleteIndex("newRequest"),Tj(d,"newRequestV2",["status","interface","timestamp"]));c(7)&&b.h.objectStoreNames.contains("sapisid")&&b.h.deleteObjectStore("sapisid");c(9)&&b.h.objectStoreNames.contains("SWHealthLog")&&b.h.deleteObjectStore("SWHealthLog")},
version:9});return cm()}
;function em(a){return Uk(dm(),a)}
function fm(a,b){var c,d,e,f;return x(function(g){if(1==g.h)return c={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(g,em(b),2);if(3!=g.h)return d=g.i,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:P("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(g,Oj(d,"LogsRequestsStore",e),3);f=g.i;c.Cb=U();gm(c);return g.return(f)})}
function hm(a,b){var c,d,e,f,g,h,k;return x(function(l){if(1==l.h)return c={startTime:U(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,em(b),2);if(3!=l.h)return d=l.i,e=P("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,U()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,V(d,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(m){return Yj(m.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(n){n.M()&&(k=n.M(),"NEW"===a&&(k.status="QUEUED",n.update(k)))})}),
3);
c.Cb=U();gm(c);return l.return(k)})}
function im(a,b){var c;return x(function(d){if(1==d.h)return w(d,em(b),2);c=d.i;return d.return(V(c,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",Ij(f.h.put(g,void 0)).then(function(){return g})})}))})}
function jm(a,b,c){c=void 0===c?!0:c;var d;return x(function(e){if(1==e.h)return w(e,em(b),2);d=e.i;return e.return(V(d,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",c&&(h.sendCount+=1),Ij(g.h.put(h,void 0)).then(function(){return h})):Bj.resolve(void 0)})}))})}
function km(a,b){var c;return x(function(d){if(1==d.h)return w(d,em(b),2);c=d.i;return d.return(c.delete("LogsRequestsStore",a))})}
function lm(a){var b,c;return x(function(d){if(1==d.h)return w(d,em(a),2);b=d.i;c=U()-2592E6;return w(d,V(b,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(e){return Vj(e.objectStore("LogsRequestsStore"),{},function(f){if(f.M().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function mm(){x(function(a){return w(a,ml(),0)})}
function gm(a){if(!R("nwl_csi_killswitch")&&.01>=Math.random()){var b=C("ytPubsub2Pubsub2Instance");b&&b.publish.call(b,"nwl_transaction_latency_payload".toString(),"nwl_transaction_latency_payload",a)}}
;var nm={},om=ql("ServiceWorkerLogsDatabase",{da:(nm.SWHealthLog={ga:1},nm),Da:!0,upgrade:function(a,b){b(1)&&Tj(Mj(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}),"swHealthNewRequest",["interface","timestamp"])},
version:1});function pm(a){return Uk(om(),a)}
function qm(a){var b,c;x(function(d){if(1==d.h)return w(d,pm(a),2);b=d.i;c=U()-2592E6;return w(d,V(b,["SWHealthLog"],{mode:"readwrite",G:!0},function(e){return Vj(e.objectStore("SWHealthLog"),{},function(f){if(f.M().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
function vm(){if(!Y.h){var a=C("yt.networkRequestMonitor.instance")||new Y;B("yt.networkRequestMonitor.instance",a);Y.h=a}return Y.h}
...
Y.prototype.removeParams=Y.prototype.removeParams;Y.prototype.isEndpointCFR=Y.prototype.isEndpointCFR;Y.prototype.requestComplete=Y.prototype.requestComplete;Y.getInstance=vm;var wm;function xm(){wm||(wm=new ej("yt.offline"));return wm}
function ym(a){if(R("offline_error_handling")){var b=xm().get("errors",!0)||{};b[a.message]={name:a.name,stack:a.stack};a.level&&(b[a.message].level=a.level);xm().set("errors",b,2592E3,!0)}}
;function Z(){Pe.call(this);var a=this;this.l=!1;this.i=Ve();this.i.X("networkstatus-online",function(){if(a.l&&R("offline_error_handling")){var b=xm().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new aj(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;$h(d)}xm().set("errors",{},2592E3,!0)}}})}
v(Z,Pe);function zm(){if(!Z.h){var a=C("yt.networkStatusManager.instance")||new Z;B("yt.networkStatusManager.instance",a);Z.h=a}return Z.h}
...
p.Ca=function(a){a=Te(this.i,a);a.then(function(b){R("use_cfr_monitor")&&vm().requestComplete("generate_204",b)});
return a};
Z.prototype.sendNetworkCheckRequest=Z.prototype.Ca;Z.prototype.listen=Z.prototype.X;Z.prototype.enableErrorFlushing=Z.prototype.ob;Z.prototype.getWindowStatus=Z.prototype.qb;Z.prototype.networkStatusHint=Z.prototype.Y;Z.prototype.isNetworkAvailable=Z.prototype.I;Z.getInstance=zm;function Am(a){a=void 0===a?{}:a;Pe.call(this);var b=this;this.i=this.u=0;this.l=zm();var c=C("yt.networkStatusManager.instance.listen").bind(this.l);c&&(a.Ba?(this.Ba=a.Ba,c("networkstatus-online",function(){Bm(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Bm(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){Qe(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Qe(b,"publicytnetworkstatus-offline")})))}
v(Am,Pe);Am.prototype.I=function(){var a=C("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.l)():!0};
Am.prototype.Y=function(a){var b=C("yt.networkStatusManager.instance.networkStatusHint").bind(this.l);b&&b(a)};
Am.prototype.Ca=function(a){var b=this,c;return x(function(d){c=C("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.l);return R("skip_network_check_if_cfr")&&vm().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.Y((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.I())})):c?d.return(c(a)):d.return(!0)})};
function Bm(a,b){a.Ba?a.i?(We.Z(a.u),a.u=We.L(function(){a.m!==b&&(Qe(a,b),a.m=b,a.i=U())},a.Ba-(U()-a.i))):(Qe(a,b),a.m=b,a.i=U()):Qe(a,b)}
;var Cm;function Dm(){var a=Tl.call;Cm||(Cm=new Am({cc:!0,ac:!0}));a.call(Tl,this,{D:{mb:lm,aa:km,Sa:hm,yb:im,Ma:jm,set:fm},F:Cm,handleError:$h,ca:ai,R:Em,now:U,gb:ym,J:$i(),La:"publicytnetworkstatus-online",Ka:"publicytnetworkstatus-offline",va:!0,ta:.1,Aa:ci("potential_esf_error_limit",10),B:R,ha:!(bj()&&"www.youtube-nocookie.com"!==Qb(document.location.toString()))});this.j=new Wf;R("networkless_immediately_drop_all_requests")&&mm();nl("LogsDatabaseV2")}
v(Dm,Tl);function Fm(){var a=C("yt.networklessRequestController.instance");a||(a=new Dm,B("yt.networklessRequestController.instance",a),R("networkless_logging")&&fl().then(function(b){a.A=b;Vl(a);a.j.resolve();a.va&&Math.random()<=a.ta&&a.A&&qm(a.A);R("networkless_immediately_drop_sw_health_store")&&Gm(a)}));
return a}
Dm.prototype.writeThenSend=function(a,b){b||(b={});bj()||(this.h=!1);Tl.prototype.writeThenSend.call(this,a,b)};
Dm.prototype.sendThenWrite=function(a,b,c){b||(b={});bj()||(this.h=!1);Tl.prototype.sendThenWrite.call(this,a,b,c)};
Dm.prototype.sendAndWrite=function(a,b){b||(b={});bj()||(this.h=!1);Tl.prototype.sendAndWrite.call(this,a,b)};
Dm.prototype.awaitInitialization=function(){return this.j.promise};
function Gm(a){var b;x(function(c){if(!a.A)throw b=xj("clearSWHealthLogsDb"),b;return c.return(rm(a.A).catch(function(d){a.handleError(d)}))})}
function Em(a,b,c){R("use_cfr_monitor")&&Hm(a,b);if(R("use_request_time_ms_header"))b.headers&&(b.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(U())));else{var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(U())}if(c&&0===Object.keys(b).length){var e=void 0===e?"":e;var f=void 0===f?!1:f;if(a)if(e)Ki(a,void 0,"POST",e);else if(P("USE_NET_AJAX_FOR_PING_TRANSPORT",!1))Ki(a,void 0,"GET","",void 0,void 0,f);else{b:{try{var g=new Ya({url:a});if(g.j&&g.i||
g.l){var h=Pb(a.match(Ob)[5]||null);var k=!(!h||!h.endsWith("/aclk")||"1"!==Zb(a,"ri"));break b}}catch(m){}k=!1}if(k){b:{try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")){var l=!0;break b}}catch(m){}l=!1}c=l?!0:!1}else c=!1;c||um(a)}}else Hi(a,b)}
...
;var Im=z.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1};B("ytNetworklessLoggingInitializationOptions",Im);function Jm(a){var b=this;this.config_=null;a?this.config_=a:Bl()&&(this.config_=Cl());Wi(function(){Rl(b)},5E3)}
Jm.prototype.isReady=function(){!this.config_&&Bl()&&(this.config_=Cl());return!!this.config_};
function Sl(a,b,c,d){function e(y){y=void 0===y?!1:y;var A;if(d.retry&&"www.youtube-nocookie.com"!=h&&(y||R("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(A=Pl(b,c,l,k)),A)){var H=g.onSuccess,K=g.onFetchSuccess;g.onSuccess=function(M,O){Ql(A);H(M,O)};
c.onFetchSuccess=function(M,O){Ql(A);K(M,O)}}try{y&&d.retry&&!d.Ya.bypassNetworkless?(g.method="POST",d.Ya.writeThenSend?Fm().writeThenSend(q,g):Fm().sendAndWrite(q,g)):R("web_all_payloads_via_jspb")?Hi(q,g):(g.method="POST",g.postParams||(g.postParams={}),Hi(q,g))}catch(M){if("InvalidAccessError"==M.name)A&&(Ql(A),A=0),ai(Error("An extension is blocking network request."));
else throw M;}A&&Wi(function(){Rl(a)},5E3)}
!P("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ai(new aj("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var f=new aj("innertube xhrclient not ready",b,c,d);$h(f);throw f;}var g={headers:d.headers||{},method:"POST",postParams:c,postBody:d.postBody,postBodyFormat:d.postBodyFormat||"JSON",onTimeout:function(){d.onTimeout()},
...
timeout:d.timeout,withCredentials:!0};g.headers["Content-Type"]||(g.headers["Content-Type"]="application/json");var h="";(f=a.config_.ub)&&(h=f);var k=a.config_.wb||!1,l=Ll(k,h,d);Object.assign(g.headers,l);(f=g.headers.Authorization)&&!h&&(g.headers["x-origin"]=window.location.origin);var m="/youtubei/"+a.config_.sb+"/"+b,n={alt:"json"},r=a.config_.vb&&f;r=r&&f.startsWith("Bearer");r||(n.key=a.config_.rb);var q=wi(""+h+m,n||{},!0);C("ytNetworklessLoggingInitializationOptions")&&Im.isNwlInitialized?
dl().then(function(y){e(y)}):e(!1)}
;var Km=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function Lm(a){this.H=a;this.h=null;this.m=0;this.C=null;this.u=0;this.i=[];for(a=0;4>a;a++)this.i.push(0);this.l=0;this.Ea=mi(window,"mousemove",Va(this.Fa,this));this.Ga=oi(Va(this.V,this),25)}
D(Lm,pe);Lm.prototype.Fa=function(a){void 0===a.h&&hi(a);var b=a.h;void 0===a.i&&hi(a);this.h=new Fd(b,a.i)};
Lm.prototype.V=function(){if(this.h){var a=Km();if(0!=this.m){var b=this.C,c=this.h,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.m);this.i[this.l]=.5<Math.abs((d-this.u)/this.u)?1:0;for(c=b=0;4>c;c++)b+=this.i[c]||0;3<=b&&this.H();this.u=d}this.m=a;this.C=this.h;this.l=(this.l+1)%4}};
Lm.prototype.ba=function(){window.clearInterval(this.Ga);ki(this.Ea)};var Mm={};
function Nm(){var a={},b=void 0===a.zb?!1:a.zb;a=void 0===a.pb?!0:a.pb;if(null==C("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;B("_lact",c,window);B("_fact",c,window);-1==c&&Om();mi(document,"keydown",Om);mi(document,"keyup",Om);mi(document,"mousedown",Om);mi(document,"mouseup",Om);b?mi(window,"touchmove",function(){Pm("touchmove",200)},{passive:!0}):(mi(window,"resize",function(){Pm("resize",200)}),a&&mi(window,"scroll",function(){Pm("scroll",200)}));
new Lm(function(){Pm("mouse",100)});
mi(document,"touchstart",Om,{passive:!0});mi(document,"touchend",Om,{passive:!0})}}
function Pm(a,b){Mm[a]||(Mm[a]=!0,We.L(function(){Om();Mm[a]=!1},b))}
...
;var Rm=z.ytPubsubPubsubInstance||new N,Sm=z.ytPubsubPubsubSubscribedKeys||{},Tm=z.ytPubsubPubsubTopicToKeys||{},Um=z.ytPubsubPubsubIsSynchronous||{};N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.la;N.prototype.publish=N.prototype.ea;N.prototype.clear=N.prototype.clear;B("ytPubsubPubsubInstance",Rm);B("ytPubsubPubsubTopicToKeys",Tm);B("ytPubsubPubsubIsSynchronous",Um);B("ytPubsubPubsubSubscribedKeys",Sm);var Vm=Symbol("injectionDeps");function Wm(){this.i=new Map;this.h=new Map}
Wm.prototype.resolve=function(a){return Xm(this,a,[])};
function Xm(a,b,c){var d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.h.has(b))return a.h.get(b);if(!a.i.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.i.get(b);c.push(b);if(d.Fb)var e=d.Fb;else if(d.Eb)e=d[Vm]?Ym(a,d[Vm],c):[],e=d.Eb.apply(d,ia(e));else if(d.Db){e=d.Db;var f=e[Vm]?Ym(a,e[Vm],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ia(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.ic||a.h.set(b,e);return e}
...
;var dn=ci("initial_gel_batch_timeout",2E3),en=ci("gel_queue_timeout_max_ms",6E4),fn=Math.pow(2,16)-1,gn=void 0;function hn(){this.j=this.h=this.i=0}
var jn=new hn,kn=new hn,ln,mn=!0,nn=z.ytLoggingTransportGELQueue_||new Map;B("ytLoggingTransportGELQueue_",nn);var on=z.ytLoggingTransportGELProtoQueue_||new Map;B("ytLoggingTransportGELProtoQueue_",on);var pn=z.ytLoggingTransportTokensToCttTargetIds_||{};B("ytLoggingTransportTokensToCttTargetIds_",pn);var qn=z.ytLoggingTransportTokensToJspbCttTargetIds_||{};B("ytLoggingTransportTokensToJspbCttTargetIds_",qn);var rn={};function sn(){var a=C("yt.logging.ims");a||(a=new $m,B("yt.logging.ims",a));return a}
function tn(a,b){R("web_all_payloads_via_jspb")&&ai(new aj("transport.log called for JSON in JSPB only experiment"));if("log_event"===a.endpoint){un(a);var c=vn(a);if(R("use_new_in_memory_storage")){rn[c]=!0;var d={cttAuthInfo:c,isJspb:!1};sn().storePayload(d,a.payload);wn(b,[],c,!1,d)}else d=nn.get(c)||[],nn.set(c,d),d.push(a.payload),wn(b,d,c)}}
function xn(a,b){if("log_event"===a.endpoint){un(void 0,a);var c=vn(a,!0);if(R("use_new_in_memory_storage")){rn[c]=!0;var d={cttAuthInfo:c,isJspb:!0};sn().storePayload(d,a.payload.toJSON());wn(b,[],c,!0,d)}else d=on.get(c)||[],on.set(c,d),a=a.payload.toJSON(),d.push(a),wn(b,d,c,!0)}}
function wn(a,b,c,d,e){d=void 0===d?!1:d;a&&(gn=new a);a=ci("tvhtml5_logging_max_batch_ads_fork")||ci("tvhtml5_logging_max_batch")||ci("web_logging_max_batch")||100;var f=U(),g=d?kn.j:jn.j;b=b.length;e&&(b=sn().getSequenceCount(e));b>=a?ln||(ln=yn(function(){zn({writeThenSend:!0},R("flush_only_full_queue")?c:void 0,d);ln=void 0},0)):10<=f-g&&(An(d),d?kn.j=f:jn.j=f)}
function Bn(a,b){R("web_all_payloads_via_jspb")&&ai(new aj("transport.logIsolatedGelPayload called in JSPB only experiment"));if("log_event"===a.endpoint){un(a);var c=vn(a),d=new Map;d.set(c,[a.payload]);b&&(gn=new b);return new Xf(function(e,f){gn&&gn.isReady()?Cn(d,gn,e,f,{bypassNetworkless:!0},!0):e()})}}
function Dn(a,b){if("log_event"===a.endpoint){un(void 0,a);var c=vn(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(gn=new b);return new Xf(function(e){gn&&gn.isReady()?En(d,gn,e,{bypassNetworkless:!0},!0):e()})}}
function vn(a,b){var c="";if(a.dangerousLogToVisitorSession)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new Mh;c.videoId?md(d,1,Nh,c.videoId):c.playlistId&&md(d,2,Nh,c.playlistId);qn[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),pn[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function zn(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;!c&&R("web_all_payloads_via_jspb")&&ai(new aj("transport.flushLogs called for JSON in JSPB only experiment"));new Xf(function(d,e){c?(Fn(kn.i),Fn(kn.h),kn.h=0):(Fn(jn.i),Fn(jn.h),jn.h=0);if(gn&&gn.isReady())if(R("use_new_in_memory_storage")){var f=a,g=c,h=gn;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,l=new Map;if(void 0!==b)g?(e=sn().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),k.set(b,e),En(k,h,d,f)):(k=sn().extractMatchingEntries({isJspb:g,
cttAuthInfo:b}),l.set(b,k),Cn(l,h,d,e,f));else if(g){e=u(Object.keys(rn));for(g=e.next();!g.done;g=e.next())l=g.value,g=sn().extractMatchingEntries({isJspb:!0,cttAuthInfo:l}),0<g.length&&k.set(l,g),delete rn[l];En(k,h,d,f)}else{k=u(Object.keys(rn));for(g=k.next();!g.done;g=k.next()){g=g.value;var m=sn().extractMatchingEntries({isJspb:!1,cttAuthInfo:g});0<m.length&&l.set(g,m);delete rn[g]}Cn(l,h,d,e,f)}}else f=a,k=c,h=gn,f=void 0===f?{}:f,k=void 0===k?!1:k,void 0!==b?k?(e=new Map,k=on.get(b)||[],e.set(b,
k),En(e,h,d,f),on.delete(b)):(k=new Map,l=nn.get(b)||[],k.set(b,l),Cn(k,h,d,e,f),nn.delete(b)):k?(En(on,h,d,f),on.clear()):(Cn(nn,h,d,e,f),nn.clear());else An(c),d()})}
function An(a){a=void 0===a?!1:a;if(R("web_gel_timeout_cap")&&(!a&&!jn.h||a&&!kn.h)){var b=yn(function(){zn({writeThenSend:!0},void 0,a)},en);
a?kn.h=b:jn.h=b}Fn(a?kn.i:jn.i);b=P("LOGGING_BATCH_TIMEOUT",ci("web_gel_debounce_ms",1E4));R("shorten_initial_gel_batch_timeout")&&mn&&(b=dn);b=yn(function(){zn({writeThenSend:!0},void 0,a)},b);
a?kn.i=b:jn.i=b}
function Cn(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(U()),h=a.size,k={};a=u(a);for(var l=a.next();!l.done;k={na:k.na,U:k.U,fa:k.fa,pa:k.pa,oa:k.oa},l=a.next()){var m=u(l.value);l=m.next().value;m=m.next().value;k.U=mb({context:Dl(b.config_||Cl())});if(!Ma(m)&&!R("throw_err_when_logevent_malformed_killswitch")){d();break}k.U.events=m;(m=pn[l])&&Gn(k.U,l,m);delete pn[l];k.fa="visitorOnlyApprovedKey"===l;Hn(k.U,g,k.fa);In(e);k.pa=function(n){R("update_log_event_config")&&We.L(function(){return x(function(r){return w(r,
Jn(n),0)})});
h--;h||c()};
k.na=0;k.oa=function(n){return function(){n.na++;if(e.bypassNetworkless&&1===n.na)try{Sl(b,"log_event",n.U,Kn({writeThenSend:!0},n.fa,n.pa,n.oa,f)),mn=!1}catch(r){$h(r),d()}h--;h||c()}}(k);
try{Sl(b,"log_event",k.U,Kn(e,k.fa,k.pa,k.oa,f)),mn=!1}catch(n){$h(n),d()}}}
function En(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(U()),g=a.size,h=new Map([].concat(ia(a)));h=u(h);for(var k=h.next();!k.done;k=h.next()){var l=u(k.value).next().value,m=a.get(l);k=new Oh;var n=Kl(b.config_||Cl());J(k,sh,1,n);m=m?Ln(m):[];m=u(m);for(n=m.next();!n.done;n=m.next())td(k,3,Jh,n.value);(m=qn[l])&&Mn(k,l,m);delete qn[l];l="visitorOnlyApprovedKey"===l;Nn(k,f,l);In(d);k=Bd(k);l=Kn(d,l,function(r){R("update_log_event_config")&&We.L(function(){return x(function(q){return w(q,Jn(r),
0)})});
g--;g||c()},function(){g--;
g||c()},e);
l.headers["Content-Type"]="application/json+protobuf";l.postBodyFormat="JSPB";l.postBody=k;Sl(b,"log_event","",l);mn=!1}}
function In(a){R("always_send_and_write")&&(a.writeThenSend=!1)}
function Kn(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Ya:a,dangerousLogToVisitorSession:b,Zb:!!e,headers:{},postBodyFormat:"",postBody:""};On()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(U())));return a}
function Hn(a,b,c){On()||(a.requestTimeMs=String(b));R("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=P("EVENT_ID"))&&(c=Pn(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function Nn(a,b,c){On()||I(a,2,b);if(!c&&(b=P("EVENT_ID"))){c=Pn();var d=new Lh;I(d,1,b);I(d,2,c);J(a,Lh,5,d)}}
function Pn(){var a=P("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*fn/2));a++;a>fn&&(a=1);Uh("BATCH_CLIENT_COUNTER",a);return a}
...
function Mn(a,b,c){if(ud(c,1===nd(c,Nh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;J(a,Mh,4,c);a=od(a,sh,1)||new sh;c=od(a,qh,3)||new qh;var e=new ph;I(e,2,b);I(e,1,d);td(c,12,ph,e);J(a,qh,3,c)}
function Ln(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new Jh(a[c]))}catch(d){$h(new aj("Transport failed to deserialize "+String(a[c])))}return b}
function un(a,b){if(C("yt.logging.transport.enableScrapingForTest")){var c=C("yt.logging.transport.scrapedPayloadsForTesting"),d=C("yt.logging.transport.payloadToScrape","");b&&(b=C("yt.logging.transport.getScrapedPayloadFromClientEventsFunction").bind(b.payload)())&&c.push(b);a&&a.payload[d]&&c.push((null==a?void 0:a.payload)[d]);B("yt.logging.transport.scrapedPayloadsForTesting",c)}}
function On(){return R("use_request_time_ms_header")||R("lr_use_request_time_ms_header")}
function yn(a,b){return R("transport_use_scheduler")?Wi(a,b):ni(a,b)}
function Fn(a){R("transport_use_scheduler")?We.Z(a):window.clearTimeout(a)}
function Jn(a){var b,c,d,e,f,g,h,k,l,m;return x(function(n){if(1==n.h){d=null==(b=a)?void 0:null==(c=b.responseContext)?void 0:c.globalConfigGroup;var r=d?d[ch.name]:void 0;e=r;g=null==(f=d)?void 0:f.hotHashData;r=d?d[bh.name]:void 0;h=r;l=null==(k=d)?void 0:k.coldHashData;Zm||(Zm=new Wm);m=Zm.resolve(yl);return g?e?w(n,zl(m,g,e),2):w(n,zl(m,g),2):n.s(2)}return l?h?w(n,Al(m,l,h),0):w(n,Al(m,l),0):n.s(0)})}
;var Qn=z.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",Qn);
function Rn(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||U());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;R("enable_unknown_lact_fix_on_html5")&&Nm();a=Qm();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};R("log_sequence_info_on_gel_web")&&d.sequenceGroup&&(a=e.context,b=d.sequenceGroup,b={index:Sn(b),groupKey:b},a.sequence=b,d.endOfSequence&&delete Qn[d.sequenceGroup]);(d.sendIsolatedPayload?Bn:tn)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,
dangerousLogToVisitorSession:d.dangerousLogToVisitorSession},c)}
function Tn(a){zn(void 0,void 0,void 0===a?!1:a)}
function Sn(a){Qn[a]=a in Qn?Qn[a]+1:0;return Qn[a]}
;var Un=[];var Vn=z.ytLoggingGelSequenceIdObj_||{};B("ytLoggingGelSequenceIdObj_",Vn);function Wn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;P("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:Jm;b=void 0===b?{}:b;var d=Math.round(b.timestamp||U());I(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Qm();d=new Ih;I(d,1,b.timestamp||!isFinite(e)?-1:e);if(R("log_sequence_info_on_gel_web")&&b.sequenceGroup){e=b.sequenceGroup;var f=Sn(e),g=new Hh;I(g,2,f);I(g,1,e);J(d,Hh,3,g);b.endOfSequence&&delete Vn[b.sequenceGroup]}J(a,Ih,33,d);(b.sendIsolatedPayload?Dn:xn)({endpoint:"log_event",payload:a,
cttAuthInfo:b.cttAuthInfo,dangerousLogToVisitorSession:b.dangerousLogToVisitorSession},c)}
;function Xn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;c.timestamp=Math.round(c.timestamp||U());var d=Jm;P("ytLoggingEventsDefaultDisabled",!1)&&Jm===Jm&&(d=null);R("web_all_payloads_via_jspb")?Un.push({fc:a,payload:b,options:c}):Rn(a,b,d,c)}else d=Jm,P("ytLoggingEventsDefaultDisabled",!1)&&Jm==Jm&&(d=null),Rn(a,b,d,c)}
;var Yn=[{Ja:function(a){return"Cannot read property '"+a.key+"'"},
...
za:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var $n={T:[],S:[{lb:Zn,weight:500}]};function Zn(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function ao(){this.S=[];this.T=[]}
var bo;function co(){if(!bo){var a=bo=new ao;a.T.length=0;a.S.length=0;$n.T&&a.T.push.apply(a.T,$n.T);$n.S&&a.S.push.apply(a.S,$n.S)}return bo}
;var eo=new N;function fo(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=go(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=go(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=go(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function go(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function ho(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=io(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=fo(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?io(e+".ve",f,g,h):0;d+=g;d+=io(e,a[e],b,c);if(500<d)break}}else c[b]=jo(a),d+=c[b].length;else c[b]=jo(a),d+=c[b].length;return d}
function io(a,b,c,d){c+="."+a;a=jo(b);d[c]=a;return c.length+a.length}
function jo(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var ko=new Set,lo=0,mo=0,no=0,oo=[],po=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function qo(){for(var a=u(po),b=a.next();!b.done;b=a.next()){var c=Kb();if(c&&0<=c.toLowerCase().indexOf(b.value.toLowerCase()))return!0}return!1}
;function ro(){var a;return x(function(b){return(a=qf())?b.return(a.then(function(c){c=Bd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return wc(d,3)})):b.return(Promise.resolve(null))})}
;var so={};function to(a){return so[a]||(so[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var uo={},vo=[],Kg=new N,wo={};function xo(){for(var a=u(vo),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function zo(a){Kg.ea.apply(Kg,arguments)}
...
function Co(a,b,c){Do||(Do={},mi(window,"message",function(d){a:{if(d.origin===Bo(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Do[e.id])d.u=!0,d.u&&(E(d.m,d.sendMessage,d),d.m.length=0),d.Na(e)}e=void 0}return e}));
Do[c]=b}
var Do=null;var Eo=window;
function Fo(a,b,c){this.o=this.h=this.i=null;this.j=0;this.u=!1;this.m=[];this.l=null;this.H={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.C=c;c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Rb(a.src):"https://www.youtube.com"),this.i=new Ao(b),c||(b=Go(this,a),this.o=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Qa(this.h)),uo[this.h.id]=this,window.postMessage){this.l=
...
p.Na=function(a){Jo(this,a.event,a)};
...
p.destroy=function(){this.h&&this.h.id&&(uo[this.h.id]=null);var a=this.l;a&&"function"==typeof a.dispose&&a.dispose();if(this.o){a=this.h;var b=a.parentNode;b&&b.replaceChild(this.o,a)}else(a=this.h)&&a.parentNode&&a.parentNode.removeChild(a);Do&&(Do[this.id]=null);this.i=null;a=this.h;for(var c in kb)kb[c][0]==a&&ki(c);this.o=this.h=null};
...
function Jo(a,b,c){a.l.j||(c={target:a,data:c},a.l.ea(b,c),zo(a.C+"."+b,c))}
...
var h=""+Bo(a.i,"host")+("/embed/"+Bo(a.i,"videoId"))+"?"+Tb(g);Eo.yt_embedsEnableUaChProbe?ro().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Td(l.href).toString();Pd(c,Ud(k));return k}):Eo.yt_embedsEnableIframeSrcWithIntent?Pd(c,Ud(h)):c.src=h;
return c}
p.Za=function(){this.h&&this.h.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.j)};
function Ho(a){Co(a.i,a,a.id);a.j=oi(a.Za.bind(a),250);mi(a.h,"load",function(){window.clearInterval(a.j);a.j=oi(a.Za.bind(a),250)})}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(R("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=lo)){var m=void 0,n=void 0,r=f,q=g,y=Jd(r),A=y.message||"Unknown Error",H=y.name||"UnknownError",
K=y.stack||r.i||"Not available";if(K.startsWith(H+": "+A)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",pb=y.fileName||"Not available",uc=K,Aa=0;if(r.hasOwnProperty("args")&&r.args&&r.args.length)for(var ra=0;ra<r.args.length&&!(Aa=ho(r.args[ra],"params."+ra,q,Aa),500<=Aa);ra++);else if(r.hasOwnProperty("params")&&r.params){var X=r.params;if("object"===typeof r.params)for(n in X){if(X[n]){var ca="params."+n,da=jo(X[n]);q[ca]=da;Aa+=ca.length+da.length;if(500<Aa)break}}else q.params=
jo(X)}if(oo.length)for(var W=0;W<oo.length&&!(Aa=ho(oo[W],"params.context."+W,q,Aa),500<=Aa);W++);navigator.vendor&&!q.hasOwnProperty("vendor")&&(q["device.vendor"]=navigator.vendor);var S={message:A,name:H,lineNumber:O,fileName:pb,stack:uc,params:q,sampleWeight:1},bk=Number(r.columnNumber);isNaN(bk)||(S.lineNumber=S.lineNumber+":"+bk);if("IGNORED"===r.level)m=0;else a:{for(var ck=co(),dk=u(ck.T),$f=dk.next();!$f.done;$f=dk.next()){var ek=$f.value;if(S.message&&S.message.match(ek.dc)){m=ek.weight;
break a}}for(var fk=u(ck.S),ag=fk.next();!ag.done;ag=fk.next()){var gk=ag.value;if(gk.lb(S)){m=gk.weight;break a}}m=1}S.sampleWeight=m;for(var hk=u(Yn),bg=hk.next();!bg.done;bg=hk.next()){var cg=bg.value;if(cg.za[S.name])for(var ik=u(cg.za[S.name]),dg=ik.next();!dg.done;dg=ik.next()){var jk=dg.value,Wd=S.message.match(jk.regexp);if(Wd){S.params["params.error.original"]=Wd[0];for(var eg=jk.groups,kk={},Vb=0;Vb<eg.length;Vb++)kk[eg[Vb]]=Wd[Vb+1],S.params["params.error."+eg[Vb]]=Wd[Vb+1];S.message=cg.Ja(kk);
break}}}S.params||(S.params={});var lk=co();S.params["params.errorServiceSignature"]="msg="+lk.T.length+"&cb="+lk.S.length;S.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==rb&&(S.params["params.fconst"]="true");var ua=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ua);if(0!==ua.sampleWeight&&!ko.has(ua.message)){if("ERROR"===h){eo.ea("handleError",
ua);if(R("record_app_crashed_web")&&0===no&&1===ua.sampleWeight)if(no++,R("errors_via_jspb")){var fg=new Gh;I(fg,1,1);if(!R("report_client_error_with_app_crash_ks")){var mk=new Bh;I(mk,1,ua.message);var nk=new Ch;J(nk,Bh,3,mk);var ok=new Dh;J(ok,Ch,5,nk);var pk=new Eh;J(pk,Dh,9,ok);J(fg,Eh,4,pk)}var Ro=fg,qk=new Jh;rd(qk,Gh,20,Kh,Ro);Wn(qk)}else{var rk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};R("report_client_error_with_app_crash_ks")||(rk.systemHealth={crashData:{clientError:{logMessage:{message:ua.message}}}});
Xn("appCrashed",rk)}mo++}else"WARNING"===h&&eo.ea("handleWarning",ua);if(R("kevlar_gel_error_routing"))a:{var gg=void 0,hg=void 0,Mc=h,Q=ua;if(R("errors_via_jspb")){if(qo())hg=void 0;else{var Wb=new yh;I(Wb,1,Q.stack);Q.fileName&&I(Wb,4,Q.fileName);var Na=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Na.length&&(1!==Na.length||isNaN(Number(Na[0]))?2!==Na.length||isNaN(Number(Na[0]))||isNaN(Number(Na[1]))||(I(Wb,2,Number(Na[0])),I(Wb,3,Number(Na[1]))):I(Wb,2,Number(Na[0])));var vb=
new Bh;I(vb,1,Q.message);I(vb,3,Q.name);I(vb,6,Q.sampleWeight);"ERROR"===Mc?I(vb,2,2):"WARNING"===Mc?I(vb,2,1):I(vb,2,0);var ig=new zh;I(ig,1,!0);rd(ig,yh,3,Ah,Wb);var wb=new vh;I(wb,3,window.location.href);for(var sk=P("FEXP_EXPERIMENTS",[]),jg=0;jg<sk.length;jg++){var tk=wb,So=sk[jg];Xc(tk);ld(tk,5,2,!1,!1).push(So)}var kg=Vh();if(!Wh()&&kg)for(var uk=u(Object.keys(kg)),xb=uk.next();!xb.done;xb=uk.next()){var vk=xb.value,lg=new xh;I(lg,1,vk);I(lg,2,String(kg[vk]));td(wb,4,xh,lg)}var mg=Q.params;
if(mg){var wk=u(Object.keys(mg));for(xb=wk.next();!xb.done;xb=wk.next()){var xk=xb.value,ng=new xh;I(ng,1,"client."+xk);I(ng,2,String(mg[xk]));td(wb,4,xh,ng)}}var yk=P("SERVER_NAME"),zk=P("SERVER_VERSION");if(yk&&zk){var og=new xh;I(og,1,"server.name");I(og,2,yk);td(wb,4,xh,og);var pg=new xh;I(pg,1,"server.version");I(pg,2,zk);td(wb,4,xh,pg)}var Xd=new Ch;J(Xd,vh,1,wb);J(Xd,zh,2,ig);J(Xd,Bh,3,vb);hg=Xd}var Ak=hg;if(!Ak)break a;var Bk=new Jh;rd(Bk,Ch,163,Kh,Ak);Wn(Bk)}else{if(qo())gg=void 0;else{var Nc=
{stackTrace:Q.stack};Q.fileName&&(Nc.filename=Q.fileName);var Oa=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Oa.length&&(1!==Oa.length||isNaN(Number(Oa[0]))?2!==Oa.length||isNaN(Number(Oa[0]))||isNaN(Number(Oa[1]))||(Nc.lineNumber=Number(Oa[0]),Nc.columnNumber=Number(Oa[1])):Nc.lineNumber=Number(Oa[0]));var qg={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Mc?qg.level="ERROR_LEVEL_ERROR":"WARNING"===Mc&&(qg.level="ERROR_LEVEL_WARNNING");
var To={isObfuscated:!0,browserStackInfo:Nc},Xb={pageUrl:window.location.href,kvPairs:[]};P("FEXP_EXPERIMENTS")&&(Xb.experimentIds=P("FEXP_EXPERIMENTS"));var rg=Vh();if(!Wh()&&rg)for(var Ck=u(Object.keys(rg)),yb=Ck.next();!yb.done;yb=Ck.next()){var Dk=yb.value;Xb.kvPairs.push({key:Dk,value:String(rg[Dk])})}var sg=Q.params;if(sg){var Ek=u(Object.keys(sg));for(yb=Ek.next();!yb.done;yb=Ek.next()){var Fk=yb.value;Xb.kvPairs.push({key:"client."+Fk,value:String(sg[Fk])})}}var Gk=P("SERVER_NAME"),Hk=P("SERVER_VERSION");
Gk&&Hk&&(Xb.kvPairs.push({key:"server.name",value:Gk}),Xb.kvPairs.push({key:"server.version",value:Hk}));gg={errorMetadata:Xb,stackTrace:To,logMessage:qg}}var Ik=gg;if(!Ik)break a;Xn("clientError",Ik)}if("ERROR"===Mc||R("errors_flush_gel_always_killswitch"))b:if(R("migrate_events_to_ts"))c:{if(R("web_fp_via_jspb")&&(Tn(!0),!R("web_fp_via_jspb_and_json")))break c;Tn()}else{if(R("web_fp_via_jspb")&&(Tn(!0),!R("web_fp_via_jspb_and_json")))break b;Tn()}}if(!R("suppress_error_204_logging")){var zb=ua,
Oc=zb.params||{},ab={urlParams:{a:"logerror",t:"jserror",type:zb.name,msg:zb.message.substr(0,250),line:zb.lineNumber,level:h,"client.name":Oc.name},postParams:{url:P("PAGE_NAME",window.location.href),file:zb.fileName},method:"POST"};Oc.version&&(ab["client.version"]=Oc.version);if(ab.postParams){zb.stack&&(ab.postParams.stack=zb.stack);for(var Jk=u(Object.keys(Oc)),tg=Jk.next();!tg.done;tg=Jk.next()){var Kk=tg.value;ab.postParams["client."+Kk]=Oc[Kk]}var ug=Vh();if(ug)for(var Lk=u(Object.keys(ug)),
vg=Lk.next();!vg.done;vg=Lk.next()){var Mk=vg.value;ab.postParams[Mk]=ug[Mk]}var Nk=P("SERVER_NAME"),Ok=P("SERVER_VERSION");Nk&&Ok&&(ab.postParams["server.name"]=Nk,ab.postParams["server.version"]=Ok)}Hi(P("ECATCHER_REPORT_HOST","")+"/error_204",ab)}try{ko.add(ua.message)}catch(Yo){}lo++}}}}}else throw Ub;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function Mo(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
v(Oo,Fo);p=Oo.prototype;p.Qa=function(){var a=Bo(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Bo(this.i,"embedConfig")){if(Pa(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
p.Na=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Pa(a))for(var c in a)a.hasOwnProperty(c)&&(this.O[c]=a[c]);break;case "infoDelivery":Po(this,a);break;case "initialDelivery":Pa(a)&&(window.clearInterval(this.j),this.playerInfo={},this.O={},Qo(this,a.apiInterface),Po(this,a));break;default:Jo(this,b,a)}};
function Po(a,b){if(Pa(b)){for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c]);a.playerInfo.hasOwnProperty("videoData")&&(b=a.playerInfo.videoData,b.hasOwnProperty("title")&&b.title?(b=b.title,b!==a.videoTitle&&(a.videoTitle=b,a.h.setAttribute("title",b))):(a.videoTitle="",a.h.setAttribute("title","YouTube "+Bo(a.i,"title"))))}}
...
this.O={};Lo(this,c,arguments);return this}:No(c)?this[c]=function(){var d=0;
...
return this})},a)}
p.getVideoEmbedCode=function(){var a=Bo(this.i,"host")+("/embed/"+Bo(this.i,"videoId")),b=Number(Bo(this.i,"width")),c=Number(Bo(this.i,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);var d=this.videoTitle;Gb.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(Ab,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(Bb,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(Cb,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(Db,"&quot;")),-1!=a.indexOf("'")&&(a=a.replace(Eb,
...
B("YT.scan",xo);B("YT.subscribe",function(a,b,c){Kg.subscribe(a,b,c);wo[a]=!0;for(var d in uo)uo.hasOwnProperty(d)&&Io(uo[d],a)});
...
vo.push(function(a){var b=a;b||(b=document);a=gb(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var e=b.getElementsByClassName("yt-player");b=e}else{e=b.getElementsByTagName("*");var f={};for(c=d=0;b=e[c];c++){var g=b.className,h;if(h="function"==typeof g.split)h=0<=bb(g.split(/\s+/),
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=gb(b);E(fb(a,b),Uo)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||xo();var Vo=z.onYTReady;Vo&&Vo();var Wo=z.onYouTubeIframeAPIReady;Wo&&Wo();var Xo=z.onYouTubePlayerAPIReady;Xo&&Xo();}).call(this);
